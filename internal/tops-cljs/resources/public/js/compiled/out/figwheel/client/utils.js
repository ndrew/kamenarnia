...
return document.body.dispatchEvent((new CustomEvent(event_name,(function (){var obj21880 = {"detail":data};
return obj21880;
})())));
} else {
return null;
...
var args21885 = [];
var len__17884__auto___21891 = arguments.length;
var i__17885__auto___21892 = (0);
while(true){
if((i__17885__auto___21892 < len__17884__auto___21891)){
args21885.push((arguments[i__17885__auto___21892]));

var G__21893 = (i__17885__auto___21892 + (1));
i__17885__auto___21892 = G__21893;
continue;
} else {
}
break;
...
return console.warn(p1__21881_SHARP_);
});
...
return console.debug(p1__21882_SHARP_);
});
;})(pred__21888,expr__21889))
} else {
...
return console.error(p1__21883_SHARP_);
});
;})(pred__21888,expr__21889))
} else {
return ((function (pred__21888,expr__21889){
return (function (p1__21884_SHARP_){
return console.log(p1__21884_SHARP_);
});
;})(pred__21888,expr__21889))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__21895){
...
var eval_fn = cljs.core.get.call(null,map__21898__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
//# sourceMappingURL=utils.js.map?rel=1451419086474